...
import su.nextlevel.launcher.util.OsType;
...
public class SetupController {
    ...
    @FXML
    public TextField directoryLine;
    @FXML
            ...
            try {
                ...
                try {
                    if (Main.isNewBool) {
                        ...
                        Main.primaryStageStatic.setScene(new Scene(FXMLLoader.load(Objects.requireNonNull(ConstantPool.CLASS_LOADER.getResource("login.fxml")))));
                    } else {
